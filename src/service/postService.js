...
class PostService {
    ...
    async getPosts(filters = {}, options = {}) {
        try {
            ...
            if (maxRating) query['food_review.rating'] = { ...query['food_review.rating'], $lte: maxRating };
    ...
    async getFoodReviewsByRating(minRating, maxRating = 5, userId = null, options = {}) {
        try {
            return await this.getPosts(
